...
class ClaimsControllerTest < ActionController::TestCase
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post :create, claim: { date_of_incident: @claim.date_of_incident, description: @claim.description, type_of_incident: @claim.type_of_incident, value: @claim.value }
    end
  ...
  test "should update claim" do
    patch :update, id: @claim, claim: { date_of_incident: @claim.date_of_incident, description: @claim.description, type_of_incident: @claim.type_of_incident, value: @claim.value }
    assert_redirected_to claim_path(assigns(:claim))
  end

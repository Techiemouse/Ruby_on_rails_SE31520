...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { breakdown_cover: @policy.breakdown_cover, policy_excess: @policy.policy_excess, windscreen_repair: @policy.windscreen_repair }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { breakdown_cover: @policy.breakdown_cover, policy_excess: @policy.policy_excess, windscreen_repair: @policy.windscreen_repair }
    assert_redirected_to policy_path(assigns(:policy))
  end
